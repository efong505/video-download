# CHUNK 5A: NEW MEXICO SUMMARY - PART 1

## TASK: Generate FIRST HALF of summary only

**This chunk covers:**
1. Database Summary + Political Landscape (2,000 words)
2. 2026 Federal Races - Senate + ALL 3 House Districts (4,000 words)
...
### ABSOLUTELY REQUIRED:
- ✅ Write EVERY House district (1-3) completely with full candidate profiles
...
```markdown
# New Mexico 2025-2026 Elections - Complete Christian Conservatives Today Guide
...
[Write 5-7 full paragraphs covering political landscape, urban-rural divide, why New Mexico matters, conservative opportunities, etc. MINIMUM 2,000 words]
