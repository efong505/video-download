# CHUNK 1: TEXAS RACES ARRAY ONLY

## TASK: Provide ONLY the races array for Texas 2025-2026
...
- ✅ EXACTLY 295 races (MANDATORY - COUNT AND VERIFY)
- ✅ Every race must have: state, office, election_date, race_type, description
- ✅ Base ALL data on real sources (Ballotpedia, Texas.gov)
- ✅ Cite sources in descriptions

## REQUIRED RACES:

### Federal (2026) - 39 races
1. U.S. Senate
2-39. U.S. House Districts 1-38 (ALL 38)

### State (2026) - 2 races
Governor, Lieutenant Governor

### State Legislature (2026) - 181 races
...
races = [
    {
        ...
        "race_type": "general",
        "description": "Research from Ballotpedia and Texas.gov..."
    },
    # CONTINUE FOR ALL 295 RACES
]
```
