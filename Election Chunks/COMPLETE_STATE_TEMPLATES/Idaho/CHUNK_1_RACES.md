# CHUNK 1: IDAHO RACES ARRAY ONLY

## TASK: Provide ONLY the races array for Idaho 2025-2026
...
- ✅ EXACTLY 148 races (MANDATORY - COUNT AND VERIFY)
- ✅ Every race must have: state, office, election_date, race_type, description
- ✅ Base ALL data on real sources (Ballotpedia, Idaho.gov)
...
races = [
    {
        ...
        "race_type": "general",
        "description": "Research from Ballotpedia and Idaho.gov..."
    },
    # CONTINUE FOR ALL 148 RACES
]
```
