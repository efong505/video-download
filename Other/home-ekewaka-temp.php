...
function portfoliox_intro_section_output()
{
  ...
  $portfoliox_btn_text_three = get_theme_mod('portfoliox_btn_text_three', __('Contact', 'portfoliox'));
  $portfoliox_btn_url_three = get_theme_mod('portfoliox_btn_url_three', '#');
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="content">
              ...
              <?php endif; ?>
				<!-- NEW TAGLINE / SUB-DESIGNATION -->
<h3 class="hero-tagline">
  Design, build, and operate production-grade AWS serverless platforms — from concept to global deployment.
</h3>
              ...
              <?php endif; ?>
              <?php if ($portfoliox_btn_url_three) : ?>
                <a href="<?php echo esc_url($portfoliox_btn_url_three); ?>" class="btn btn-hero"><?php echo esc_html($portfoliox_btn_text_three); ?></a>
              <?php endif; ?>
				<!-- Authority Signals -->
              <div class="authority-signals">
                <div class="authority-signal">
                  <div class="authority-value">95% IaC</div>
                  <div class="authority-label">Terraform-managed AWS</div>
                </div>
                <div class="authority-signal">
                  <div class="authority-value">18 Lambdas</div>
                  <div class="authority-label">CI/CD + versioned releases</div>
                </div>
                <div class="authority-signal">
                  <div class="authority-value">&lt; 1s Rollback</div>
                  <div class="authority-label">Blue/Green via aliases</div>
                </div>
              </div>
