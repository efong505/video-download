...
# Pennsylvania Summary with full emoji formatting
summary = {
    "state": "Pennsylvania",
...
Total Candidates Profiled: 2+ major candidates (expanding)
Election Dates:
...
- **Swing State**: Biden won by 1.2% (2020), Trump won by 0.7% (2016)
- **Electoral Power**: 19 electoral votes - critical for presidential elections
- **Geographic Divide**: Philadelphia/Pittsburgh blue, "Pennsyltucky" red
- **Working Class**: Steel, coal, manufacturing workers - culturally conservative
- **Religious Heritage**: Strong Catholic, Lutheran, evangelical presence
- **Suburban Battleground**: Philadelphia suburbs decide statewide races

Why Pennsylvania Matters

Pennsylvania is WINNABLE for Christian conservatives:

✅ **Working Class Appeal**: Blue-collar workers shifting Republican on economy, values
✅ **Energy Workers**: Fracking, coal workers oppose Democrat green policies
✅ **Rural Strength**: Central PA deeply conservative, high turnout potential
✅ **Pro-Life Base**: Strong Catholic and evangelical pro-life movement
✅ **School Choice**: Growing parental rights movement in suburbs
✅ **Crime Concerns**: Philadelphia crime crisis drives suburban voters right

🔴 2026 U.S. SENATE RACE
Pennsylvania U.S. Senate - November 3, 2026

Context: Critical race for Senate control. Pennsylvania's Senate seat determines national policy.

**Bob Casey Jr. (D) - Incumbent Senator**
- Elected 2006, seeking fourth term
- Son of pro-life Governor Bob Casey Sr., but votes pro-choice
- Moderate image but votes with Biden 98% of the time
- Vulnerable on inflation, border, crime

**Republican Challengers (TBD)**
- Strong recruitment underway
- Focus on economy, border security, crime
- Opportunity to flip seat

Why It Matters: This Senate seat could determine control of the U.S. Senate and stop the radical Democrat agenda.
...
- Moderate image but progressive policies
- Focus on education, infrastructure

**Republican Challengers (TBD)**
- Multiple candidates exploring
- Focus on crime, economy, parental rights

Why It Matters: Governor controls state policy on life, education, religious freedom, and election integrity.

🔴 2026 U.S. HOUSE RACES
All 17 Pennsylvania Congressional Districts

**Competitive Districts:**
- **District 7 (Lehigh Valley)**: Swing district, suburban battleground
- **District 8 (Scranton)**: Working-class district, Trump-Biden voters
- **District 10 (Harrisburg)**: Competitive suburban district
- **District 17 (Western PA)**: Rural conservative district

**Safe Republican Districts:**
- Districts 9, 11, 12, 13, 14, 16 - Conservative strongholds

**Safe Democrat Districts:**
- Districts 1, 2, 3 (Philadelphia area) - Urban progressive

Why It Matters: House control determines national policy on life, family, religious freedom.
...
Why It Matters: These offices shape state policy on values, spending, and accountability.
...
- Promote LGBTQ+ curriculum in schools
...
- Focus on academics, not activism
...
**Early Voting:**
- Mail-in ballot applications available 50 days before election
- In-person early voting (check county for dates)
...
- iVoterGuide.org - Pennsylvania coverage
- Pennsylvania Family Institute - Faith-based voter education
- Pennsylvania Pro-Life Federation - Pro-life candidate ratings
...
- Voter Registration Status: vote.pa.gov/register

**Conservative Organizations:**
- Pennsylvania Family Institute - Christian policy advocacy
- Pennsylvania Pro-Life Federation - Life advocacy
- Commonwealth Foundation - Free market policy
- Independence Law Center - Religious liberty legal defense

**News & Information:**
- Christian Conservatives Today - Election coverage
- Pennsylvania Capital-Star - State politics
- Local conservative talk radio

🔥 BOTTOM LINE FOR PENNSYLVANIA CHRISTIANS

**2026 Elections Matter:**
- U.S. Senate race determines Senate control
...
- Wisdom for Pennsylvania Christian voters
- Church mobilization and high turnout
- Protection from voter fraud
- Revival in Pennsylvania
- Pro-life victories
- Religious freedom protection
- Defeat of radical progressive agenda
- Unity among Christian conservatives
- God's will to be done in Pennsylvania
...
print("Uploading Pennsylvania comprehensive summary...")
summaries_table.put_item(Item=summary)
print("[SUCCESS] Pennsylvania summary uploaded with full emoji formatting!")
