...
# Run this script from the Downloader directory
...
pip install PyJWT -t $PackageDir --upgrade
...
if ($FunctionExists) {
    ...
    Write-Host "⬆️ Updating function code..." -ForegroundColor Yellow
...
Write-Host "1. Create DynamoDB table: python create_feature_flags_table.py"
Write-Host "2. Create API Gateway HTTP API and connect to this Lambda function"
Write-Host "3. Update feature-flags.js with your API Gateway URL"
Write-Host "4. Update admin-feature-flags.html with your API Gateway URL"
Write-Host "5. Add 'Feature Flags' link to admin.html navigation"
Write-Host ""
