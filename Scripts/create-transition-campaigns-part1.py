...
campaign_1 = {
    ...
    'campaign_name': 'Transition #1 - Welcome Back',
    'campaign_group': 'election-map-transition-sequence',
    'subject': "Remember when you signed up for election updates? Here's what's happened since...",
    'content': '''
<!DOCTYPE html>
<html>
<head>
...
campaign_2 = {
    'user_id': PLATFORM_OWNER_ID,
    'campaign_id': str(uuid.uuid4()),
    'campaign_name': 'Transition #2 - The 7 Mountains',
    'campaign_group': 'election-map-transition-sequence',
    'subject': 'The 7 Mountains that shape our world (and why Christians need to climb them)',
    'content': '''
<!DOCTYPE html>
<html>
<head>
...
print("Creating campaigns 1 and 2...")

try:
    campaigns_table.put_item(Item=campaign_1)
    print(f"✅ Created: {campaign_1['campaign_name']} (ID: {campaign_1['campaign_id']})")
    
    campaigns_table.put_item(Item=campaign_2)
    print(f"✅ Created: {campaign_2['campaign_name']} (ID: {campaign_2['campaign_id']})")
    
    print("\n✅ Part 1 complete! Campaigns 1-2 created.")
